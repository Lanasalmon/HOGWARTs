...
def process_gcn(payload, root):
    ...
    for d in range(0,len(contours)):
        ...
        f = open("/home/swalsh/HOGWARTs/static/"+graceid+prelim+str(levelsper[d])+".json", "w")
        ...
        f = open("/home/swalsh/HOGWARTs/static/"+graceid+prelim+str(levelsper[d])+".dat", "w")
        f.write( csv2 )      # str() converts to string
        f.close()

    
payload = open('S190828j-3-Update.xml', 'rb').read()
