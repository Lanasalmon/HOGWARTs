...
#next let's do it, and git commit separately. then try. and then undo.

payload = open('S190512at-2-Initial.xml', 'rb').read()
root = lxml.etree.fromstring(payload)
process_gcn(payload, root)

#now i need 99 and the file for download - save in correct directory and then 
#
